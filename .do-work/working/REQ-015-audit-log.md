...
**Claimed at:** 2026-06-24T09:13:34Z
**Heartbeat:** 2026-06-24T09:13:34Z
<!-- claimed-end -->
...
- [ ] `AuditLog` records entries in order with step name, status, duration, and optional model/token fields.
- [ ] LLM-step entries carry model id and token usage; deterministic-step entries carry an error count.
- [ ] Entries are retrievable as an ordered list suitable for JSON serialization.
- [ ] A failed step is recorded with `failed` status rather than throwing.
